...
function MoreIcon() {
  return (
    <svg className="reader-top-bar__more-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
      <path d="M5 13.3332C5.7364 13.3332 6.33335 12.7362 6.33335 11.9998C6.33335 11.2635 5.7364 10.6665 5 10.6665C4.26364 10.6665 3.66669 11.2635 3.66669 11.9998C3.66669 12.7362 4.26364 13.3332 5 13.3332ZM12 13.3332C12.7364 13.3332 13.3334 12.7362 13.3334 11.9998C13.3334 11.2635 12.7364 10.6665 12 10.6665C11.2636 10.6665 10.6667 11.2635 10.6667 11.9998C10.6667 12.7362 11.2636 13.3332 12 13.3332ZM19 13.3332C19.7364 13.3332 20.3334 12.7362 20.3334 11.9998C20.3334 11.2635 19.7364 10.6665 19 10.6665C18.2636 10.6665 17.6667 11.2635 17.6667 11.9998C17.6667 12.7362 18.2636 13.3332 19 13.3332Z" fill="currentColor" />
    </svg>
  )
}
